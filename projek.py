...
def warna():
    ...
    glBegin(GL_POLYGON)
    glColor3ub(100, 800, 100)
    glVertex2d(100, 180)#a
    glVertex2d(100, 320)#c

    glVertex2d(100, 320)#c
    glVertex2d(120, 320)#d

    glVertex2d(120, 320)#d
    glVertex2d(300, 320)#e

    glVertex2d(300, 320)#e
    glVertex2d(300, 180)#b
    glEnd()

    glBegin(GL_POLYGON)
    glColor3ub(100, 800, 100)
    glVertex2d(120, 320)#d
    glVertex2d(120, 340)#g

    glVertex2d(120, 340)#g
    glVertex2d(300, 340)#f
